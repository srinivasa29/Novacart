    ...
    const collections = [
        {
            ...
            image: '/collections/minimalist.png',
            products: 24,
    ...
    return (
        <div className="collections-page" style={{ padding: '4rem 0' }}>
            ...
            <div className="reveal-up" style={{ textAlign: 'center', marginBottom: '8rem' }}>
                ...
                <button className="btn-primary" style={{ padding: '1rem 2.5rem', borderRadius: '16px', fontSize: '1rem', display: 'inline-flex', alignItems: 'center', gap: '0.8rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))', gap: '3rem' }}>
                {collections.map((col, idx) => (
                    <div key={col.id} className="card reveal-up hover-shine" style={{ height: '600px', position: 'relative', overflow: 'hidden', padding: 0, animationDelay: `${idx * 0.1}s` }}>
